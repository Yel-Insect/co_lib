...
static co_lib::ConfigVar<uint64_t>::ptr g_tcp_server_read_timeout = 
    co_lib::Config::Lookup("tcp_server.read_timeout", (uint64_t)(60 * 1000 * 2), "tcp server read timeout");

TcpServer::TcpServer(co_lib::IOManager* worker, co_lib::IOManager* accept_worker) 
    : m_worker(worker)
...
bool TcpServer::bind(co_lib::Address::ptr addr) {
